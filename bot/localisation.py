...
class Localisation:
    ...
    DOWNLOAD_START = "initiatin download bud.... \n"
    
    UPLOAD_START = "can you wait for the upload \n"
    
    COMPRESS_START = "📀 Trying to initiate the sequence ... 📀"
